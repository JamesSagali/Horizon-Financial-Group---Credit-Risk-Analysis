...
| `analysis_report.md` | Downloadable standalone report as a markdown file |
| `analysis_report.pdf` | Downloadable standalone report for stakeholders and the underwriting team |
